...
namespace Laba1Tests
{
    ...
    public class MonitorTechTests
    {
        ...
        {
            var resolution = new List<int> { 1920, 1080 };
            var monitor = new MonitorTech("Samsung", resolution, 27.0f, 144);

            Assert.AreEqual("Samsung", monitor.Manufacturer);
            CollectionAssert.AreEqual(new List<int> { 1920, 1080 }, monitor.Resolution);
        ...
        {
            var invalidResolution = new List<int> { 1920 };
        ...
        {
            var invalidResolution = new List<int> { 0, 1080 };
            var monitor = new MonitorTech("Samsung", invalidResolution, 27.0f, 144);
        }
        ...
        {
            var monitor = new MonitorTech("LG", new List<int> { 1920, 1080 }, 24.0f, 60);
            var newResolution = new List<int> { 2560, 1440 };
        ...
        {
            var monitor = new MonitorTech("LG", new List<int> { 1920, 1080 }, 24.0f, 60);
            var invalidResolution = new List<int> { 2560, 1440, 2160 };
        ...
        {
            var monitor = new MonitorTech("Dell", new List<int> { 1920, 1080 }, 24.0f, 60);
            monitor.SetResolution(3840, 2160);

            CollectionAssert.AreEqual(new List<int> { 3840, 2160 }, monitor.Resolution);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void SetResolution_InvalidHeight_ThrowsException()
        {
            var monitor = new MonitorTech("Dell", new List<int> { 1920, 1080 }, 24.0f, 60);
            monitor.SetResolution(1920, -1);
        }

        [TestMethod]
        public void ScreenSize_PropertySetter_ValidValue_SetsCorrectly()
        {
            var monitor = new MonitorTech("ASUS", new List<int> { 1920, 1080 }, 24.0f, 60);
        ...
        {
            var monitor = new MonitorTech("Acer", new List<int> { 1920, 1080 }, 24.0f, 60);
        ...
        {
            var originalResolution = new List<int> { 1920, 1080 };
            ...
            Assert.AreEqual(1920, monitor.Resolution[0]);
        }
    }
}